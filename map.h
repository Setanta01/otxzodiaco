...
class Map
{
	public:
		...
		static constexpr int32_t maxViewportX = 18; //min value: getViewportX(isOTClient) + 1
		static constexpr int32_t maxViewportY = 18; //min value: maxClientViewportY + 1
		static constexpr int32_t oldClientViewportX = 8;
		static constexpr int32_t oldClientViewportY = 6;
		static constexpr int32_t otClientViewportX = 15;
		static constexpr int32_t otClientViewportY = 12;
		static inline int32_t getViewportX(bool isOTClient) {
			return isOTClient ? otClientViewportX : oldClientViewportX;
		}

		static inline int32_t getViewportY(bool isOTClient) {
			return isOTClient ? otClientViewportY : oldClientViewportY;
		}
		...
		*/
		bool canThrowObjectTo(const Position& fromPos, const Position& toPos, bool checkLineOfSight = true,
			...
			int32_t rangex = 11, int32_t rangey = 11);
